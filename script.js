$(document).ready(function () {
    ...
    $("#navcountdown").click(function () {
        ...
        $("#phorloge").css("color", "#fff");
        $("#imgreveil").attr("src", "img/reveil0.png");
        $("#preveil").css("color", "#fff");
        $("#imgcountdown").attr("src", "img/countdown.png");
        $("#pcountdown").css("color", "yellowgreen");
        $("#imgchrono").attr("src", "img/chrono0.png");
        $("#pchrono").css("color", "#fff");
        $("#chorloge").hide();
        $("#ccountdown").show();
    ...
    function setAlarm(j) {
        ...
        if (diff < 0) {
            alert("La date choisie est déjà passée.");
            return;
        }
